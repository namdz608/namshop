...
import { authMock, authMockRequest, authMockResponse, authUserPayload } from '../test/mocks/auth.mock';
import { read_user, resendEmail } from '../current-user';
import * as auth from '../../services/auth.services';
import * as helper from '@namdz608/jobber-shared';
import { Sequelize } from 'sequelize';

jest.mock('@namdz608/jobber-shared');
