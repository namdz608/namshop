...
import { getAuthUserByPasswordToken, getUserByEmail, getUserByUsername, updatePassword, updatePasswordToken } from '../services/auth.services';
import { BadRequestError, IAuthDocument, IEmailMessageDetails } from '@namdz608/jobber-shared';
...
export async function forgotPassword(req: Request, res: Response): Promise<void> {
  ...
  const resetLink = `${process.env.CLIENT_URL}/reset_password?token=${randomCharacters}`;
