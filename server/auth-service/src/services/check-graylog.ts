...
export class Health {
    ...
    public test(_req: Request, res: Response) { //Dấu gạch dưới _ ở trước tên req ngụ ý rằng nó không được sử dụng trong hàm.
        res.status(StatusCodes.OK).send('Test services is healthy and OK')
    }
}